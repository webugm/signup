<?php
/* Smarty version 3.1.30, created on 2017-07-03 15:54:13
  from "C:\UniServerZ\www\signup\templates\bootstrap\theme.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5959f825df1de3_51845144',
...
function content_5959f825df1de3_51845144 (Smarty_Internal_Template $_smarty_tpl) {
              ...
              <div class="panel-body">
                ...
                <form action="index.php" method="POST" role="form" class="form-horizontal">
                  ...
                  <div class="text-center">
                    <button type="submit" name="op" value="login" class="btn btn-primary">Submit</button>
                  </div>
                </form>
              </div>
            </div>
    ...
    <section>
      ...
      <div class="container">
        ...
        <table class="table table-hover table-bordered">
          <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['users']->value, 'user', true);
...
$_smarty_tpl->tpl_vars['user']->first = !$_smarty_tpl->tpl_vars['user']->index;
