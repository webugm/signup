<?php
/* Smarty version 3.1.30, created on 2017-07-03 12:48:21
  from "C:\UniServerZ\www\signup\templates\new-age\theme.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5959cc9531d3f6_58409439',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2916836283036b3b185ccea12eaf7319c2b94e4d' => 
    array (
      0 => 'C:\\UniServerZ\\www\\signup\\templates\\new-age\\theme.tpl',
      1 => 1499057292,
      2 => 'file',
    ),
  ),
...
function content_5959cc9531d3f6_58409439 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
lib/simple-line-icons/css/simple-line-icons.css">
    <link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['xoImgUrl']->value;?>
lib/device-mockups/device-mockups.min.css">

    <!-- Theme CSS -->
    <link href="<?php echo $_smarty_tpl->tpl_vars['xoImgUrl']->value;?>
css/new-age.min.css" rel="stylesheet">
...
img/demo-screen-1.jpg" class="img-responsive" alt="">
                                </div>
                                <div class="button">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="badges">
                        <a class="badge-link" href="#"><img src="<?php echo $_smarty_tpl->tpl_vars['xoImgUrl']->value;?>
img/google-play-badge.svg" alt=""></a>
                        <a class="badge-link" href="#"><img src="<?php echo $_smarty_tpl->tpl_vars['xoImgUrl']->value;?>
img/app-store-badge.svg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="device-mockup iphone6_plus portrait white">
                            <div class="device">
                                <div class="screen">
                                    <!-- Demo image for screen mockup, you can put an image here, some HTML, an animation, video, or anything else! -->
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['xoImgUrl']->value;?>
img/demo-screen-1.jpg" class="img-responsive" alt=""> </div>
                                <div class="button">
                                    <!-- You can hook the "home button" to some JavaScript events or just remove it -->
                                </div>
                            </div>
...
>
    ...
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['xoImgUrl']->value;?>
js/new-age.min.js"><?php echo '</script'; ?>
>
